...
// Output: pros
// Explanation: "pros" is the longest word with all prefixes ("p", "pr", "pro", "pros")
// present in the array words[].
// Input: words[] = ["ab", "a", "abc", "abd"]
// Output: abc
// Explanation: Both "abc" and "abd" has all the prefixes in words[]. 
//Since, "abc" is lexicographically smaller than "abd", so the output is "abc".
// Constraints:
// 1 ≤ words.length() ≤ 103
